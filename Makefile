...
a.out: build/main.o build/read_from_file.o build/sort_strings.o build/swap_strings.o
...
build/read_from_file.o: src/file/read_from_file.cpp
	@$(CC) $(CFLAGS) -c src/file/read_from_file.cpp -o build/read_from_file.o

build/sort_strings.o: src/strings/sort_strings.cpp
	@$(CC) $(CFLAGS) -c src/strings/sort_strings.cpp -o build/sort_strings.o

build/swap_strings.o: src/strings/swap_strings.cpp
	@$(CC) $(CFLAGS) -c src/strings/swap_strings.cpp -o build/swap_strings.o
